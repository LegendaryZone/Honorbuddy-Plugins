...
namespace farm_stein
{
    ...
    {
        public override string Name { get { return "Farm Wetland"; } }
        ...
        {
            return ObjectManager.GetObjectsOfType<WoWUnit>().Where(u => (u.FactionId == 2272 ||u.FactionId == 2273) && u.IsAlive && u.Attackable && !u.TaggedByOther).OrderBy(u => u.Distance).FirstOrDefault();
        }
